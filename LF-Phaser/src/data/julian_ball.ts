...
const data: CharacterData = {
  ...
  0: { name: "flying",
    ...
    itr: {
      kind: 0, x: 22, y: 27, w: 55, h: 27, dvx: 16, fall: 70, vrest: 10, bdefend: 16, injury: 12
    },
    bdy: {
  ...
  2: { name: "flying",
    pic: 0, state: 3006, wait: 1, next: 3, dvx: 18, dvy: 0, centerx: 40, centery: 41, hit_a: 15, hit_d: 40, hit_j: 0,
    itr: {
      kind: 0, x: 22, y: 27, w: 55, h: 27, dvx: 16, fall: 0, vrest: 4, bdefend: 16, injury: 10
    },
    bdy: {
      kind: 0, x: 22, y: 27, w: 55, h: 27
    }
  ...
  3: { name: "flying",
    pic: 1, state: 3006, wait: 1, next: 2, dvx: 18, dvy: 0, centerx: 35, centery: 41, hit_a: 15, hit_d: 40, hit_j: 0,
    itr: {
      kind: 0, x: 22, y: 27, w: 55, h: 27, dvx: 16, fall: 0, vrest: 4, bdefend: 16, injury: 10
    },
    bdy: {
  ...
  40: { name: "disappearing",
    ...
    itr: {
      kind: 0, x: 10, y: 27, w: 55, h: 27, dvx: 1, fall: -1, vrest: 4, bdefend: 16, injury: 4
    }
  },
  ...
  100: { name: "flying",
    pic: 0, state: 3000, wait: 1, next: 101, dvx: 15, dvy: 0, centerx: 40, centery: 41, hit_a: 50, hit_d: 40, hit_j: 0,
    itr: {
      kind: 0, x: 22, y: 27, w: 55, h: 27, dvx: 16, fall: 70, vrest: 10, bdefend: 16, injury: 12
    },
    bdy: {
  ...
  101: { name: "flying",
    pic: 1, state: 3000, wait: 1, next: 100, dvx: 15, dvy: 0, centerx: 35, centery: 41, hit_a: 50, hit_d: 40, hit_j: 0,
    itr: {
      kind: 0, x: 22, y: 27, w: 55, h: 27, dvx: 16, fall: 70, vrest: 10, bdefend: 16, injury: 12
    },
    bdy: {
