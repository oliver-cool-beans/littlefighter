...
const data: CharacterData = {
  ...
  0: { name: "in_the_sky",
    ...
    itr: {
      kind: 0, x: 8, y: 21, w: 39, h: 39, dvx: 5, dvy: -7, fall: 70, vrest: 17, bdefend: 30, injury: 36
    },
    bdy: {
  ...
  21: { name: "just_on_ground",
    ...
    itr: {
      kind: 0, x: 19, y: 26, w: 21, h: 30, dvx: 5, dvy: -7, fall: 70, vrest: 17, bdefend: 30, injury: 36
    }
  },
  399: { name: "dummy",
