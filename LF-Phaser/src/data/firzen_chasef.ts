...
const data: CharacterData = {
  ...
  frame: {
  0: { name: "flying",
    pic: 0, state: 3000, wait: 5, next: 1, dvx: 0, dvy: 0, dvz: 0, centerx: 46, centery: 26, hit_a: 1, hit_d: 1, hit_j: 0, hit_Fa: 7,
    bdy: {
      kind: 0, x: 33, y: 21, w: 23, h: 28
    }
  },
  1: { name: "flying",
    pic: 1, state: 3000, wait: 5, next: 2, dvx: 0, dvy: 0, dvz: 0, centerx: 42, centery: 36, hit_a: 1, hit_d: 1, hit_j: 0, hit_Fa: 7,
    itr: {
      kind: 0, x: 22, y: 22, w: 39, h: 38, dvx: 3, fall: 70, vrest: 15, bdefend: 20, injury: 10, effect: 2
    },
    bdy: {
  ...
  2: { name: "flying",
    pic: 2, state: 3000, wait: 5, next: 3, dvx: 0, dvy: 0, dvz: 0, centerx: 50, centery: 48, hit_a: 1, hit_d: 2, hit_j: 0, hit_Fa: 7,
    itr: {
      kind: 0, x: 29, y: 27, w: 36, h: 39, dvx: 3, fall: 70, vrest: 15, bdefend: 20, injury: 10, effect: 2
    },
    bdy: {
  ...
  3: { name: "flying",
    pic: 3, state: 3000, wait: 1, next: 0, dvx: 0, dvy: 0, dvz: 0, centerx: 44, centery: 45, hit_a: 1, hit_d: 3, hit_j: 0, hit_Fa: 7,
    itr: {
      kind: 0, x: 22, y: 22, w: 39, h: 38, dvx: 3, fall: 70, vrest: 15, bdefend: 20, injury: 10, effect: 2
    },
    bdy: {
  ...
  61: { name: "hiting_ground",
    pic: 5, state: 3001, wait: 0, next: 62, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 40, hit_a: 0, hit_d: 0, hit_j: 0,
    sound: "1/020",
    opoint: {
      kind: 1, x: 46, y: 50, action: 0, dvx: 0, dvy: 0, oid: 210, facing: 21
    }
  },
  62: { name: "hiting_ground",
    pic: 6, state: 3001, wait: 0, next: 63, dvx: 0, dvy: 0, dvz: 0, centerx: 41, centery: 40, hit_a: 0, hit_d: 0, hit_j: 0,
    opoint: {
      kind: 1, x: 46, y: 50, action: 0, dvx: 0, dvy: 0, oid: 210, facing: 20
    }
  },
  ...
  80: { name: "disaster1",
    pic: 20, state: 3005, wait: 10, next: 1000, dvx: 0, dvy: 0, dvz: 0, centerx: 42, centery: 27, hit_a: 0, hit_d: 0, hit_j: 0, hit_Fa: 11
  },
  81: { name: "disaster2",
    pic: 20, state: 3005, wait: 10, next: 1000, dvx: 0, dvy: 0, dvz: 0, centerx: 42, centery: 27, hit_a: 0, hit_d: 0, hit_j: 0, hit_Fa: 9
  }
  }
