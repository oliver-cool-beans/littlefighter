...
const data: CharacterData = {
  ...
  frame: {
  0: { name: "flying",
    pic: 0, state: 3000, wait: 2, next: 1, dvx: 25, dvy: 0, centerx: 90, centery: 41, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 22, y: 27, w: 55, h: 27, dvx: 20, dvy: -10, fall: 70, vrest: 8, bdefend: 16, injury: 54
    },
    bdy: {
  ...
  1: { name: "flying",
    pic: 1, state: 3000, wait: 2, next: 999, dvx: 25, dvy: 0, centerx: 90, centery: 41, hit_a: 0, hit_d: 0, hit_j: 0,
    opoint: {
      kind: 1, x: 130, y: 20, action: 50, dvx: 0, dvy: 0, oid: 220, facing: 0
    },
    itr: {
      kind: 0, x: 22, y: 27, w: 55, h: 27, dvx: 20, dvy: -10, fall: 70, vrest: 8, bdefend: 16, injury: 54
    },
  ...
  2: { name: "flying",
    pic: 2, state: 3000, wait: 2, next: 3, dvx: 25, dvy: 0, centerx: 90, centery: 41, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 22, y: 27, w: 55, h: 27, dvx: 13, dvy: -8, fall: 10, vrest: 8, bdefend: 16, injury: 13
    },
    bdy: {
      kind: 0, x: 22, y: 27, w: 55, h: 27
    }
  ...
  3: { name: "flying",
    pic: 3, state: 3000, wait: 2, next: 2, dvx: 25, dvy: 0, centerx: 90, centery: 41, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 22, y: 27, w: 55, h: 27, dvx: 13, dvy: -8, fall: 10, vrest: 8, bdefend: 16, injury: 13
    },
    bdy: {
