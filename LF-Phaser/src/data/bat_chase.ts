...
const data: CharacterData = {
  ...
  frame: {
  0: { name: "flying",
    pic: 0, state: 3000, wait: 1, next: 1, dvx: 0, dvy: 0, dvz: 0, centerx: 43, centery: 39, hit_a: 2, hit_d: 0, hit_j: 0, hit_Fa: 12,
    itr: {
      kind: 0, x: 22, y: 22, w: 39, h: 38, dvx: 4, fall: 20, vrest: 15, bdefend: 16, injury: 4
    },
    bdy: {
  ...
  1: { name: "flying",
    pic: 1, state: 3000, wait: 1, next: 2, dvx: 0, dvy: 0, dvz: 0, centerx: 47, centery: 43, hit_a: 2, hit_d: 1, hit_j: 0, hit_Fa: 12,
    itr: {
      kind: 0, x: 22, y: 22, w: 39, h: 38, dvx: 4, fall: 20, vrest: 15, bdefend: 16, injury: 4
    },
    bdy: {
  ...
  2: { name: "flying",
    pic: 2, state: 3000, wait: 1, next: 3, dvx: 0, dvy: 0, dvz: 0, centerx: 45, centery: 44, hit_a: 2, hit_d: 2, hit_j: 0, hit_Fa: 12,
    itr: {
      kind: 0, x: 22, y: 22, w: 39, h: 38, dvx: 4, fall: 20, vrest: 15, bdefend: 16, injury: 4
    },
    bdy: {
  ...
  3: { name: "flying",
    pic: 1, state: 3000, wait: 1, next: 999, dvx: 0, dvy: 0, dvz: 0, centerx: 47, centery: 45, hit_a: 2, hit_d: 3, hit_j: 0, hit_Fa: 12,
    itr: {
      kind: 0, x: 22, y: 22, w: 39, h: 38, dvx: 4, fall: 20, vrest: 15, bdefend: 16, injury: 4
    },
    bdy: {
  ...
  12: { name: "hiting",
    ...
    opoint: {
      kind: 1, x: 42, y: 41, action: 130, dvx: 0, dvy: 0, oid: 315, facing: 0
    }
  },
  13: { name: "hiting",
