...
const data: CharacterData = {
  bmp: {
    file: [
      {
        "file(0-99)": "sprite/weapon12.png", w: 69, h: 69, row: 10, col: 4
      }
    ],
    name: 'weapon12',
    weapon_hp: 100000,
  ...
  weapon_strength_list: {
    1: {
      entry: "normal", dvx: 2, fall: 70, vrest: 10, bdefend: 16, injury: 33, effect: 2
    },
    2: {
      entry: "jump", dvx: 7, fall: 70, vrest: 10, bdefend: 16, injury: 33, effect: 2
    },
    3: {
      entry: "run", dvx: 10, fall: 70, vrest: 10, bdefend: 16, injury: 44, effect: 2
    },
    4: {
      entry: "dash", dvx: 12, fall: 70, vrest: 10, bdefend: 60, injury: 44, effect: 2
    }
  },
  frame: {
  0: { name: "in_the_sky",
  ...
  20: { name: "on_hand",
    ...
    itr: {
      kind: 5, x: 29, y: 1, w: 15, h: 78, fall: 70, bdefend: 16, injury: 33
    }
  },
  21: { name: "on_hand",
    ...
    itr: [
      {
        kind: 5, x: 38, y: 5, w: 18, h: 34, dvx: 8, fall: 70, bdefend: 16, injury: 33
      },
      {
        kind: 5, x: 20, y: 35, w: 22, h: 40, dvx: 8, fall: 70, bdefend: 16, injury: 33
      }
    ]
  },
  22: { name: "on_hand",
    ...
    itr: [
      {
        kind: 5, x: 8, y: 44, w: 28, h: 22, dvx: 8, fall: 70, bdefend: 16, injury: 33
      },
      {
        kind: 5, x: 40, y: 9, w: 21, h: 24, dvx: 8, fall: 70, bdefend: 16, injury: 33
      },
      {
        kind: 5, x: 26, y: 26, w: 22, h: 21, dvx: 8, fall: 70, bdefend: 16, injury: 33
      }
    ]
  },
  23: { name: "on_hand",
    ...
    itr: [
      {
        kind: 5, x: 44, y: 23, w: 25, h: 14, dvx: 8, fall: 70, bdefend: 16, injury: 33
      },
      {
        kind: 5, x: 25, y: 31, w: 27, h: 14, dvx: 8, fall: 70, bdefend: 16, injury: 33
      },
      {
        kind: 5, x: 3, y: 40, w: 28, h: 17, dvx: 8, fall: 70, bdefend: 16, injury: 33
      }
    ]
  },
  24: { name: "on_hand",
    ...
    opoint: {
      kind: 1, x: 50, y: 37, action: 0, dvx: 30, dvy: 0, oid: 327, facing: 0
    },
    itr: {
      kind: 5, x: -3, y: 32, w: 73, h: 15, dvx: 8, fall: 70, bdefend: 16, injury: 33
    }
  },
  25: { name: "on_hand",
    ...
    itr: [
      {
        kind: 5, x: 2, y: 20, w: 31, h: 18, dvx: 8, fall: 70, bdefend: 16, injury: 33
      },
      {
        kind: 5, x: 29, y: 34, w: 38, h: 22, dvx: 8, fall: 70, bdefend: 16, injury: 33
      }
    ]
  },
  26: { name: "on_hand",
    ...
    itr: [
      {
        kind: 5, x: 24, y: 27, w: 19, h: 23, dvx: 8, fall: 70, bdefend: 16, injury: 33
      },
      {
        kind: 5, x: 35, y: 42, w: 26, h: 22, dvx: 8, fall: 70, bdefend: 16, injury: 33
      },
      {
        kind: 5, x: 7, y: 12, w: 26, h: 24, dvx: 8, fall: 70, bdefend: 16, injury: 33
      }
    ]
  },
  27: { name: "on_hand",
    ...
    itr: [
      {
        kind: 5, x: 17, y: 2, w: 25, h: 33, dvx: 8, fall: 70, bdefend: 16, injury: 33
      },
      {
        kind: 5, x: 30, y: 30, w: 25, h: 41, dvx: 8, fall: 70, bdefend: 16, injury: 33
      }
    ]
  },
  28: { name: "on_hand",
    ...
    itr: {
      kind: 5, x: 26, y: -9, w: 18, h: 78, dvx: 8, fall: 70, bdefend: 16, injury: 33
    }
  },
  29: { name: "on_hand",
    ...
    itr: [
      {
        kind: 5, x: 32, y: 2, w: 21, h: 34, dvx: 8, fall: 70, bdefend: 16, injury: 33
      },
      {
        kind: 5, x: 22, y: 29, w: 18, h: 45, dvx: 8, fall: 70, bdefend: 16, injury: 33
      }
    ]
  },
  30: { name: "on_hand",
    ...
    itr: [
      {
        kind: 5, x: 9, y: 43, w: 25, h: 22, dvx: 8, fall: 70, bdefend: 16, injury: 33
      },
      {
        kind: 5, x: 37, y: 11, w: 27, h: 19, dvx: 8, fall: 70, bdefend: 16, injury: 33
      },
      {
        kind: 5, x: 28, y: 25, w: 21, h: 20, dvx: 8, fall: 70, bdefend: 16, injury: 33
      }
    ]
  },
  31: { name: "on_hand",
    ...
    itr: [
      {
        kind: 5, x: 30, y: 27, w: 44, h: 15, dvx: 8, fall: 70, bdefend: 16, injury: 33
      },
      {
        kind: 5, x: 2, y: 39, w: 42, h: 17, dvx: 8, fall: 70, bdefend: 16, injury: 33
      }
    ]
  },
  32: { name: "on_hand",
  ...
  33: { name: "on_hand",
    ...
    itr: [
      {
        kind: 5, x: 2, y: 20, w: 38, h: 20, dvx: 8, fall: 70, bdefend: 16, injury: 33
      },
      {
        kind: 5, x: 27, y: 30, w: 45, h: 28, dvx: 8, fall: 70, bdefend: 16, injury: 33
      }
    ]
  },
  34: { name: "on_hand",
    ...
    itr: [
      {
        kind: 5, x: 33, y: 37, w: 35, h: 29, dvx: 8, fall: 70, bdefend: 16, injury: 33
      },
      {
        kind: 5, x: 7, y: 10, w: 25, h: 24, dvx: 8, fall: 70, bdefend: 16, injury: 33
      },
      {
        kind: 5, x: 20, y: 25, w: 26, h: 18, dvx: 8, fall: 70, bdefend: 16, injury: 33
      }
    ]
  },
  35: { name: "on_hand",
    ...
    itr: [
      {
        kind: 5, x: 17, y: 3, w: 22, h: 32, dvx: 8, fall: 70, bdefend: 16, injury: 33
      },
      {
        kind: 5, x: 30, y: 30, w: 26, h: 44, dvx: 8, fall: 70, bdefend: 16, injury: 33
      }
    ]
  },
  40: { name: "throwing",
    ...
    itr: {
      kind: 0, x: 12, y: 16, w: 49, h: 47, dvx: 8, fall: 70, bdefend: 16, injury: 75, effect: 2
    }
  },
  41: { name: "throwing",
  ...
  61: { name: "on_ground",
    pic: 5, state: 1003, wait: 1, next: 62, dvx: 0, dvy: 0, centerx: 31, centery: 43, hit_a: 0, hit_d: 0, hit_j: 0
  },
  62: { name: "on_ground",
    pic: 3, state: 1003, wait: 1, next: 63, dvx: 0, dvy: 0, centerx: 34, centery: 46, hit_a: 0, hit_d: 0, hit_j: 0,
    sound: "1/023"
  },
  63: { name: "on_ground",
    pic: 5, state: 1003, wait: 1, next: 80, dvx: 0, dvy: 0, centerx: 32, centery: 41, hit_a: 0, hit_d: 0, hit_j: 0
  },
  64: { name: "on_ground",
  ...
  70: { name: "just_on_ground",
    ...
    sound: "1/023",
    itr: {
      kind: 0, x: 16, y: 15, w: 39, h: 46, dvx: 2, fall: 70, arest: 16, bdefend: 16, effect: 2
    }
  },
  71: { name: "just_on_on_ground",
    pic: 5, state: 1003, wait: 2, next: 72, dvx: 0, dvy: 0, centerx: 33, centery: 45, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 7, y: 31, w: 51, h: 21, dvx: 2, fall: 70, arest: 16, bdefend: 16, effect: 2
    }
  },
  72: { name: "just_on_on_ground",
    pic: 3, state: 1003, wait: 2, next: 61, dvx: 0, dvy: 0, centerx: 35, centery: 46, hit_a: 0, hit_d: 0, hit_j: 0,
    sound: "1/023",
    itr: {
      kind: 0, x: 10, y: 29, w: 52, h: 23, dvx: 2, fall: 70, arest: 16, bdefend: 16, effect: 2
    }
  },
  80: { name: "rising",
    pic: 0, state: 1002, wait: 0, next: 81, dvx: 0, dvy: -5, centerx: 35, centery: 58, hit_a: 0, hit_d: 0, hit_j: 0
  },
  81: { name: "rising",
    pic: 1, state: 1002, wait: 0, next: 82, dvx: 0, dvy: -5, centerx: 35, centery: 58, hit_a: 0, hit_d: 0, hit_j: 0
  },
  82: { name: "rising",
    pic: 2, state: 1002, wait: 0, next: 83, dvx: 0, dvy: -5, centerx: 35, centery: 58, hit_a: 0, hit_d: 0, hit_j: 0
  },
  83: { name: "rising",
    pic: 3, state: 1002, wait: 0, next: 84, dvx: 0, dvy: -5, centerx: 35, centery: 58, hit_a: 0, hit_d: 0, hit_j: 0
  },
  84: { name: "rising",
    pic: 4, state: 1002, wait: 0, next: 85, dvx: 0, dvy: -5, centerx: 35, centery: 58, hit_a: 0, hit_d: 0, hit_j: 0
  },
  85: { name: "rising",
    pic: 5, state: 1002, wait: 0, next: 86, dvx: 0, dvy: -5, centerx: 35, centery: 58, hit_a: 0, hit_d: 0, hit_j: 0
  },
  86: { name: "rising",
    pic: 6, state: 1002, wait: 0, next: 87, dvx: 0, dvy: -5, centerx: 35, centery: 58, hit_a: 0, hit_d: 0, hit_j: 0
  },
  87: { name: "rising",
    pic: 7, state: 1002, wait: 0, next: 88, dvx: 0, dvy: -5, centerx: 35, centery: 58, hit_a: 0, hit_d: 0, hit_j: 0
  },
  88: { name: "rising",
    pic: 8, state: 1002, wait: 0, next: 89, dvx: 0, dvy: -5, centerx: 35, centery: 58, hit_a: 0, hit_d: 0, hit_j: 0
  },
  89: { name: "rising",
    pic: 9, state: 1002, wait: 0, next: 90, dvx: 0, dvy: -5, centerx: 35, centery: 58, hit_a: 0, hit_d: 0, hit_j: 0
  },
  90: { name: "rising",
    pic: 10, state: 1002, wait: 0, next: 91, dvx: 0, dvy: -5, centerx: 35, centery: 58, hit_a: 0, hit_d: 0, hit_j: 0
  },
  91: { name: "rising",
    pic: 11, state: 1002, wait: 0, next: 92, dvx: 0, dvy: -5, centerx: 35, centery: 58, hit_a: 0, hit_d: 0, hit_j: 0
  },
  92: { name: "rising",
    pic: 12, state: 1002, wait: 0, next: 93, dvx: 0, dvy: -5, centerx: 35, centery: 58, hit_a: 0, hit_d: 0, hit_j: 0
  },
  93: { name: "rising",
    pic: 13, state: 1002, wait: 0, next: 94, dvx: 0, dvy: -5, centerx: 35, centery: 58, hit_a: 0, hit_d: 0, hit_j: 0
  },
  94: { name: "rising",
    pic: 14, state: 1002, wait: 0, next: 95, dvx: 0, dvy: -5, centerx: 35, centery: 58, hit_a: 0, hit_d: 0, hit_j: 0
  },
  95: { name: "rising",
    pic: 15, state: 1002, wait: 0, next: 1000, dvx: 0, dvy: -5, centerx: 35, centery: 58, hit_a: 0, hit_d: 0, hit_j: 0
  },
  399: { name: "dummy",
