...
const data: CharacterData = {
  ...
  130: { name: "flying",
    pic: 0, state: 18, wait: 1, next: 131, dvx: 0, dvy: 0, centerx: 6, centery: 46, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 6, y: 27, w: 34, h: 25, dvx: 10, dvy: -10, fall: 70, vrest: 300, bdefend: 16, injury: 85, effect: 21
    }
  },
  ...
  134: { name: "flying",
    pic: 4, state: 18, wait: 1, next: 135, dvx: 0, dvy: 0, centerx: 9, centery: 53, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 9, y: 32, w: 37, h: 23, dvx: 10, dvy: -10, fall: 70, vrest: 300, bdefend: 16, injury: 85, effect: 21
    }
  },
  135: { name: "flying",
    pic: 5, state: 18, wait: 1, next: 1000, dvx: 0, dvy: 0, centerx: 9, centery: 53, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 9, y: 32, w: 37, h: 23, dvx: 10, dvy: -10, fall: 70, vrest: 300, bdefend: 16, injury: 85, effect: 21
    }
  },
  121: { name: "explosion",
    pic: 34, state: 18, wait: 1, next: 122, dvx: 0, dvy: 0, centerx: 78, centery: 148, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 20, y: 16, w: 122, h: 135, dvx: -12, dvy: -18, fall: 70, vrest: 300, bdefend: 16, injury: 125, zwidth: 37, effect: 22
    }
  },
  122: { name: "explosion",
    pic: 35, state: 18, wait: 1, next: 123, dvx: 0, dvy: 0, centerx: 78, centery: 148, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 20, y: 16, w: 122, h: 135, dvx: -12, dvy: -18, fall: 70, vrest: 300, bdefend: 16, injury: 125, zwidth: 37, effect: 22
    }
  },
  123: { name: "explosion",
    pic: 36, state: 18, wait: 1, next: 124, dvx: 0, dvy: 0, centerx: 78, centery: 148, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 20, y: 16, w: 122, h: 135, dvx: -12, dvy: -18, fall: 70, vrest: 300, bdefend: 16, injury: 125, zwidth: 37, effect: 22
    }
  },
  124: { name: "explosion",
    pic: 37, state: 18, wait: 1, next: 1000, dvx: 0, dvy: 0, centerx: 78, centery: 148, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 20, y: 16, w: 122, h: 135, dvx: -12, dvy: -18, fall: 70, vrest: 300, bdefend: 16, injury: 125, zwidth: 37, effect: 22
    }
  }
