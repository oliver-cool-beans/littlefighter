...
const data: CharacterData = {
  ...
  1: { name: "flying",
    ...
    itr: {
      kind: 0, x: 22, y: 22, w: 39, h: 38, dvx: 3, fall: 70, vrest: 15, bdefend: 20, injury: 10, effect: 3
    },
    bdy: {
  ...
  2: { name: "flying",
    ...
    itr: {
      kind: 0, x: 29, y: 27, w: 36, h: 39, dvx: 3, fall: 70, vrest: 15, bdefend: 20, injury: 10, effect: 3
    },
    bdy: {
