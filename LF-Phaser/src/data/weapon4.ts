...
const data: CharacterData = {
  ...
  weapon_strength_list: {
    1: {
      entry: "normal", dvx: 2, fall: 40, vrest: 10, bdefend: 16, injury: 27, effect: 1
    },
    2: {
      entry: "jump", dvx: 7, fall: 70, vrest: 10, bdefend: 16, injury: 27, effect: 1
    },
    3: {
      entry: "run", dvx: 10, fall: 70, vrest: 10, bdefend: 16, injury: 33, effect: 1
    },
    4: {
      entry: "dash", dvx: 12, fall: 70, vrest: 20, bdefend: 60, injury: 33, effect: 1
    }
  },
  frame: {
  0: { name: "in_the_sky",
  ...
  40: { name: "throwing",
    ...
    itr: {
      kind: 0, x: 6, y: 16, w: 39, h: 19, dvx: 8, fall: 70, bdefend: 16, injury: 33, effect: 1
    },
    bdy: {
      kind: 0, x: 6, y: 16, w: 39, h: 19
    }
  ...
  62: { name: "on_ground",
    pic: 3, state: 1003, wait: 2, next: 63, dvx: 0, dvy: 0, centerx: 24, centery: 28, hit_a: 0, hit_d: 0, hit_j: 0,
    sound: "1/034"
  },
  63: { name: "on_ground",
