...
const data: CharacterData = {
  ...
  weapon_strength_list: {
    1: {
      entry: "normal", dvx: 2, fall: 60, vrest: 10, bdefend: 16, injury: 12, effect: 1
    },
    2: {
      entry: "jump", dvx: 7, fall: 60, vrest: 10, bdefend: 16, injury: 12, effect: 1
    },
    3: {
      entry: "run", dvx: 10, fall: 60, vrest: 10, bdefend: 16, injury: 12, effect: 1
    },
    4: {
      entry: "dash", dvx: 12, fall: 60, vrest: 20, bdefend: 60, injury: 12, effect: 1
    }
  },
  frame: {
  0: { name: "in_the_sky",
    pic: 10, state: 1000, wait: 0, next: 16, dvx: 0, dvy: 0, centerx: 24, centery: 40
  },
  1: { name: "in_the_sky",
    pic: 11, state: 1000, wait: 0, next: 16, dvx: 0, dvy: 0, centerx: 24, centery: 40
  },
  2: { name: "in_the_sky",
    pic: 11, state: 1000, wait: 0, next: 16, dvx: 0, dvy: 0, centerx: 24, centery: 40
  },
  3: { name: "in_the_sky",
    pic: 12, state: 1000, wait: 0, next: 16, dvx: 0, dvy: 0, centerx: 24, centery: 40
  },
  4: { name: "in_the_sky",
    pic: 12, state: 1000, wait: 0, next: 16, dvx: 0, dvy: 0, centerx: 24, centery: 40
  },
  5: { name: "in_the_sky",
    pic: 13, state: 1000, wait: 0, next: 16, dvx: 0, dvy: 0, centerx: 24, centery: 40
  },
  6: { name: "in_the_sky",
    pic: 13, state: 1000, wait: 0, next: 16, dvx: 0, dvy: 0, centerx: 24, centery: 40
  },
  7: { name: "in_the_sky",
    pic: 14, state: 1000, wait: 0, next: 16, dvx: 0, dvy: 0, centerx: 24, centery: 40
  },
  8: { name: "in_the_sky",
    pic: 14, state: 1000, wait: 0, next: 16, dvx: 0, dvy: 0, centerx: 24, centery: 40
  },
  9: { name: "in_the_sky",
    pic: 15, state: 1000, wait: 0, next: 16, dvx: 0, dvy: 0, centerx: 24, centery: 40
  },
  10: { name: "in_the_sky",
    pic: 16, state: 1000, wait: 0, next: 16, dvx: 0, dvy: 0, centerx: 24, centery: 40
  },
  11: { name: "in_the_sky",
    pic: 16, state: 1000, wait: 0, next: 16, dvx: 0, dvy: 0, centerx: 24, centery: 40
  },
  12: { name: "in_the_sky",
    pic: 17, state: 1000, wait: 0, next: 16, dvx: 0, dvy: 0, centerx: 24, centery: 40
  },
  13: { name: "in_the_sky",
    pic: 17, state: 1000, wait: 0, next: 16, dvx: 0, dvy: 0, centerx: 24, centery: 40
  },
  14: { name: "in_the_sky",
    pic: 18, state: 1000, wait: 0, next: 16, dvx: 0, dvy: 0, centerx: 24, centery: 40
  },
  15: { name: "in_the_sky",
    pic: 19, state: 1000, wait: 0, next: 16, dvx: 0, dvy: 0, centerx: 24, centery: 40
  },
  16: { name: "in_the_sky",
    pic: 999, state: 1000, wait: 0, next: 1000, dvx: 0, dvy: 0, centerx: 24, centery: 40,
    opoint: {
      kind: 1, x: 24, y: 30, action: 90, dvx: 0, dvy: 0, oid: 208, facing: 0
    }
  },
  20: { name: "on_hand",
    pic: 10, state: 1001, wait: 0, next: 0, dvx: 0, dvy: 0, centerx: 24, centery: 40,
    wpoint: {
      kind: 2, x: 24, y: 40
    },
    itr: {
  ...
  21: { name: "on_hand",
    pic: 11, state: 1001, wait: 0, next: 0, dvx: 0, dvy: 0, centerx: 24, centery: 40,
    wpoint: {
      kind: 2, x: 17, y: 41
    },
    itr: [
  ...
  22: { name: "on_hand",
    pic: 12, state: 1001, wait: 0, next: 0, dvx: 0, dvy: 0, centerx: 24, centery: 40,
    wpoint: {
      kind: 2, x: 12, y: 37
    },
    itr: [
  ...
  23: { name: "on_hand",
    pic: 13, state: 1001, wait: 0, next: 0, dvx: 0, dvy: 0, centerx: 24, centery: 40,
    wpoint: {
      kind: 2, x: 9, y: 33
    },
    itr: [
  ...
  24: { name: "on_hand",
    pic: 14, state: 1001, wait: 0, next: 0, dvx: 0, dvy: 0, centerx: 24, centery: 40,
    wpoint: {
      kind: 2, x: 10, y: 29
    },
    itr: {
  ...
  25: { name: "on_hand",
    pic: 15, state: 1001, wait: 0, next: 0, dvx: 0, dvy: 0, centerx: 24, centery: 40,
    wpoint: {
      kind: 2, x: 12, y: 23
    },
    itr: [
  ...
  26: { name: "on_hand",
    pic: 16, state: 1001, wait: 0, next: 0, dvx: 0, dvy: 0, centerx: 24, centery: 40,
    wpoint: {
      kind: 2, x: 14, y: 15
    },
    itr: [
  ...
  27: { name: "on_hand",
    pic: 17, state: 1001, wait: 0, next: 0, dvx: 0, dvy: 0, centerx: 24, centery: 40,
    wpoint: {
      kind: 2, x: 17, y: 13
    },
    itr: [
  ...
  28: { name: "on_hand",
    pic: 18, state: 1001, wait: 0, next: 0, dvx: 0, dvy: 0, centerx: 24, centery: 40,
    wpoint: {
      kind: 2, x: 24, y: 11
    },
    itr: {
  ...
  29: { name: "on_hand",
    pic: 19, state: 1001, wait: 0, next: 0, dvx: 0, dvy: 0, centerx: 24, centery: 40,
    wpoint: {
      kind: 2, x: 29, y: 13
    },
    itr: [
  ...
  40: { name: "throwing",
    ...
    itr: {
      kind: 0, x: 3, y: 4, w: 40, h: 39, dvx: -3, dvy: -9, fall: 60, bdefend: 16, injury: 12, effect: 1
    }
  },
  41: { name: "throwing",
  ...
  64: { name: "on_ground",
    ...
    itr: {
      kind: 0, x: 3, y: 4, w: 40, h: 39, dvx: 9, fall: 16, bdefend: 16, injury: 6, effect: 1
    }
  },
  ...
  71: { name: "just_on_on_ground",
    ...
    opoint: {
      kind: 1, x: 24, y: 36, action: 95, dvx: 0, dvy: 0, oid: 208, facing: 0
    }
  },
  ...
  140: { name: "throwing",
    ...
    itr: {
      kind: 0, x: 3, y: 4, w: 40, h: 39, dvx: 9, fall: 60, bdefend: 16, injury: 15, effect: 1
    }
  },
  141: { name: "throwing",
