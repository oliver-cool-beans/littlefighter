...
const data: CharacterData = {
  ...
  weapon_strength_list: {
    1: {
      entry: "normal", dvx: 2, fall: 40, vrest: 10, bdefend: 16, injury: 14
    },
    2: {
      entry: "jump", dvx: 7, fall: 70, vrest: 10, bdefend: 16, injury: 22
    },
    3: {
      entry: "run", dvx: 10, fall: 70, vrest: 10, bdefend: 16, injury: 31
    },
    4: {
      entry: "dash", dvx: 12, fall: 70, vrest: 20, bdefend: 60, injury: 36
    }
  },
  frame: {
  0: { name: "in_the_sky",
  ...
  40: { name: "throwing",
    ...
    itr: {
      kind: 0, x: 16, y: 16, w: 19, h: 19, fall: 60, bdefend: 16, injury: 11
    },
    bdy: {
      kind: 0, x: 16, y: 16, w: 19, h: 19
    }
